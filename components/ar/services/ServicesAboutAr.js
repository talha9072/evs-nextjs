const ServicesAboutAr = ({
  ...
  return (
    <section className="snap-section position-relative pb-0" dir="rtl">
      <div className="container">
        <div className="row align-items-center">
          ...
          <div className="col-lg-6 col-xl-6 offset-xl-1 order-2 order-lg-1 align-self-end position-relative">
            ...
            {/* Icon overlay */}
            <i
              className={`${iconClass} text-base-color fs-100 position-absolute left-minus-20px top-100px lg-top-60px md-left-100px sm-left-20px xs-left-0px`}
...
export default ServicesAboutAr;
