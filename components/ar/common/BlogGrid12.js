...
export default function BlogLoaderExact() {
  useEffect(() => {
    (function initBlogs() {
      let currentPage = 1;
        ...
        .then(xmlString => {
          ...
          function renderPaginationControls(totalPages) {
            ...
            paginationList.className =
              "pagination pagination-style-01 fs-13 fw-500 mb-0";
  ...
  return null; // 🔴 IMPORTANT: DOM already exists
}
