...
export default function CustomerReviewsSection() {
  // Swiper slider ko reinitialize karne ke liye (template ke main.min.js ke saath sync)
  useEffect(() => {
            ...
            <div className="outside-box-right-15 xl-outside-box-right-20 sm-outside-box-right-0">
              <div
                ...
                data-slider-options='{
                  ...
                  "breakpoints": { "992": { "slidesPerView": 2 }, "768": { "slidesPerView": 2 }, "320": { "slidesPerView": 1 } },
                  "effect": "slide"
                }'
              >
