...
export default function About() {
  return (
    ...
    <Head>
      ...
      <meta
        name="keywords"
        content="contact EVS UAE, EV service booking UAE, electric vehicle support Dubai, get in touch EVS, schedule EV maintenance, EV center contact UAE, reach EV specialists UAE"
      />
      ...
      {/* Open Graph */}
      <meta property="og:title" content="Contact EVS UAE | Book Your Electric Vehicle Service Today" />
      <meta
      ...
      <meta name="twitter:title" content="Contact EVS UAE | Book Your Electric Vehicle Service Today" />
      <meta
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Get in touch with Electric Vehicle Services UAE for service inquiries, appointments, or franchise opportunities.",
      ...
      <div className="col-md-6">
        <div className="py-5">
          ...
          >
            ...
            <div className="col-md-6 mb-30px">
              <select className="form-control required" name="location" defaultValue="">
...
{/* end page title */}
      ...
      {/* Branches with Google Maps Section */}
          ...
          >
            ...
            <div className="col icon-with-text-style-03">
              <div className="feature-box p-8">
                <iframe
                  ...
                  title="EVS Abu Dhabi Map"
                ></iframe>

                <div className="feature-box-content last-paragraph-no-margin">
                  <Link href="/evs-abu-dhabi" className="d-inline-block fw-700 text-white mb-5px alt-font fs-32 mt-3">
                    EVS Abu Dhabi
                  </Link>
                  ...
                  <a
                    ...
                    className="btn btn-large btn-round-edge btn-base-color btn-slide-right mt-15px xs-mt-25px"
                  >
                    Get Directions<i className="fa fa-location-arrow ms-2"></i>
                    <span className="bg-white"></span>
                  </a>
                </div>
              </div>
            ...
            <div className="col icon-with-text-style-03">
              <div className="feature-box p-8">
                ...
                <div className="feature-box-content last-paragraph-no-margin">
                  <Link href="/evs-dubai" className="d-inline-block fw-700 text-white mb-5px alt-font fs-32 mt-3">
                    EVS Dubai
                  </Link>
                  <span className="d-block">
                    <span className="text-white fw-600">T:</span>{" "}
            ...
            <div className="col icon-with-text-style-03">
              <div className="feature-box p-8">
                ...
                <div className="feature-box-content last-paragraph-no-margin">
                  <Link href="/evs-ajman" className="d-inline-block fw-700 text-white mb-5px alt-font fs-32 mt-3">
                    EVS Ajman
                  </Link>
                  <span className="d-block">
                    <span className="text-white fw-600">T:</span>{" "}
            ...
            <div className="col icon-with-text-style-03">
              <div className="feature-box p-8">
                <iframe
                  ...
                  loading="lazy"
                  referrerPolicy="no-referrer-when-downgrade"
                  title="EVS Al Ain Map"
                ></iframe>

                <div className="feature-box-content last-paragraph-no-margin">
                  <Link href="/evs-alain" className="d-inline-block fw-700 text-white mb-5px alt-font fs-32 mt-3">
                    EVS Alain
                  </Link>
                  <span className="d-block">
                    <span className="text-white fw-600">T:</span>{" "}
            ...
            <div className="col icon-with-text-style-03">
              <div className="feature-box p-8">
                <iframe
                  ...
                  loading="lazy"
                  referrerPolicy="no-referrer-when-downgrade"
                  title="EVS Sharjah Map"
                ></iframe>

                <div className="feature-box-content last-paragraph-no-margin">
                  <Link href="/evs-sharjah" className="d-inline-block fw-700 text-white mb-5px alt-font fs-32 mt-3">
                    EVS Sharjah
                  </Link>
                  <span className="d-block">
                    <span className="text-white fw-600">T:</span>{" "}
