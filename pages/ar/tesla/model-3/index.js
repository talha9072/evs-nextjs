...
<Head>
  {/* Title */}
  <title>
    خدمة تيسلا موديل 3 في دبي | صيانة وإصلاحات – إي في إس
  </title>

  {/* Meta Description */}
  <meta
    name="description"
    content="إي في إس الإمارات تقدم خدمة احترافية لتيسلا موديل 3 في دبي. احصل على تشخيص وصيانة وإصلاحات من متخصصين ذوي خبرة في المركبات الكهربائية."
  />

  {/* Meta Keywords */}
  <meta
    name="keywords"
    content="خدمة تيسلا موديل 3 دبي, صيانة موديل 3 الإمارات, إصلاح تيسلا الكهربائية دبي, تشخيص موديل 3 الإمارات, فنيو تيسلا متخصصون, دعم إي في إس موديل 3, مركز خدمة تيسلا دبي"
  />
  ...
  <meta
    property="og:title"
    content="خدمة تيسلا موديل 3 في دبي | صيانة وإصلاحات – إي في إس"
  />
  <meta
  ...
  <meta
    property="og:url"
    content="https://evsuae.com/ar/tesla/model-3"
  />
  ...
  <script
    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        ...
        "@type": "Service",
        name: "خدمة وصيانة تيسلا موديل 3 الكهربائية",
        description:
          "توفر إي في إس الإمارات خدمات تشخيص وصيانة وإصلاح متكاملة لسيارة تيسلا موديل 3 في دبي. تشمل خدماتنا فحص البطارية، تحديثات البرمجيات، الصيانة الدورية، وإصلاح المكونات لضمان أفضل أداء واعتمادية.",
        provider: {
          "@type": "Organization",
          name: "EVS UAE",
        ...
        url: "https://evsuae.com/ar/tesla/model-3",
...
<FullHeroAr
  ...
  titlePrefix=""
  titleHighlight="تيسلا موديل 3"
  titleSuffix="- خدمات الإصلاح والصيانة والضمان في الإمارات"
  description="سيارتك تيسلا موديل 3 هي سيارة كهربائية عالية الأداء، ولكنها مثل أي مركبة تحتاج إلى عناية متخصصة. من فحص صحة البطارية إلى تحديثات البرمجيات وإصلاحات الهيكل، إي في إس الإمارات تضمن أن تظل سيارتك تيسلا موديل 3 في أفضل حالاتها."
  ctaText="احجز الخدمة"
...
<CarAboutAr
  ...
  "
  imageAlt="صورة عن تيسلا موديل 3"
  heading="عن تيسلا موديل 3"
  description="تيسلا موديل 3 هي واحدة من أكثر المركبات الكهربائية شعبية، حيث تقدم مدىً مذهلاً، تسارعًا فوريًا، ومقصورة مليئة بالتقنيات. مع مدى يصل إلى 363 ميلًا لكل شحنة، فإنها توفر أداءً متميزًا، بينما تتميز مقصورة تيسلا موديل 3 بتصميم بسيط، مقاعد فاخرة، وشاشة لمسية."
/>


<CarServicesAr
  heading="خدمات إصلاح وصيانة تيسلا موديل 3"
  services={[
    {
...
<CarFaqAr
  ...
  faqs={[
    {
      question: "ما هي الخدمات التي تقدمونها لتيسلا موديل 3؟",
      answer:
        "نقدم دعمًا شاملاً لتيسلا موديل 3 يشمل التشخيص، العناية بالبطارية، إصلاحات البرمجيات، صيانة المكابح والتعليق، وإعادة معايرة الأنظمة.",
    },
    {
      question: "هل يمكنكم تشخيص فقدان المدى أو مشاكل البطارية في موديل 3؟",
      answer:
        "نعم، نحن نجري تشخيصًا عميقًا لصحة البطارية للكشف عن فقدان المدى، عدم التوازن، وتدهور الأداء.",
    },
    {
      question: "هل تقدمون إصلاحات نظام الأوتوبايلوت والكاميرات؟",
      answer:
        "نعم، نحن نخدم أنظمة أوتوبايلوت تيسلا، بما في ذلك إعادة معايرة الكاميرات وأجهزة الاستشعار لضمان القيادة الذاتية الآمنة.",
    },
    {
      question: "هل يمكنكم إجراء صيانة الإطارات والمكابح لموديل 3؟",
      answer:
        "بالتأكيد، نقدم تدوير الإطارات، استبدالها، فحص وسادات المكابح، وتنظيف الأنظمة لضمان السلامة والأداء الأمثل.",
    },
  ]}
/>
