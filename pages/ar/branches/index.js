  ...
  <div className="container position-relative">
        ...
        <div className="col icon-with-text-style-03" key={i}>
          <div className="feature-box p-8">
            ...
            <div className="feature-box-content last-paragraph-no-margin">
              ...
              {/* LG+ : title left | buttons right with gap instead of me- */}
              <div className="d-none d-lg-flex align-items-center justify-content-between gap-2">
                ...
                <div className="d-flex align-items-center gap-2"> {/* ← changed to gap-2 */}
                  <a href={`tel:${branch.phone}`} className="btn btn-small btn-round-edge btn-base-color">
                    <i className="feather icon-feather-phone-call"></i>
                  </a>
                  <a href="mailto:info@evsuae.com" className="btn btn-small btn-round-edge btn-base-color">
                    <i className="feather icon-feather-mail"></i>
                  </a>
                  <a href={branch.map} target="_blank" rel="noopener noreferrer" className="btn btn-small btn-round-edge btn-base-color">
                    <i className="feather icon-feather-map-pin"></i>
                  </a>
                </div>
              </div>

              {/* MD and below: title centered, then buttons centered with gap */}
              <div className="d-lg-none text-center">
                <a href={branch.link} className="fw-700 text-white alt-font fs-19 d-block mb-10px">
                  {branch.title}
                </a>

                <div className="d-flex align-items-center justify-content-center gap-2"> {/* ← changed to gap-2 */}
                  <a href={`tel:${branch.phone}`} className="btn btn-small btn-round-edge btn-base-color">
                    <i className="feather icon-feather-phone-call"></i>
                  </a>
                  <a href="mailto:info@evsuae.com" className="btn btn-small btn-round-edge btn-base-color">
    ...
    >
      {[
        ...
        {
          title: "إي في إس الشارقة - الموافجة",
