...
{/* Branches with Google Maps Section */}
      <section className="position-relative">
        {/* Decorative Vertical Line Background */}
        <div
              ...
              <div className="feature-box p-8">
                ...
                <div className="feature-box-content last-paragraph-no-margin">
                  ...
                  <span className="d-block">
                    ...
                    <a href="tel:+971547133313" className="urbanist" dir="ltr">
                      +971 54 713 3313
                    </a>
                  </span>
                  <span className="d-block">
            ...
            <div className="col icon-with-text-style-03">
              <div className="feature-box p-8">
                ...
                <div className="feature-box-content last-paragraph-no-margin">
                  ...
                  <span className="d-block">
                    <span className="text-white fw-600">هـ:</span>{" "}
                    <a href="tel:+971566017771" className="urbanist" dir="ltr">
                      +971 56 60 17771
                    </a>
                  </span>
                  <span className="d-block">
            ...
            <div className="col icon-with-text-style-03">
              <div className="feature-box p-8">
                ...
                <div className="feature-box-content last-paragraph-no-margin">
                  ...
                  <span className="d-block">
                    <span className="text-white fw-600">هـ:</span>{" "}
                    <a href="tel:+971564556555" className="urbanist" dir="ltr">
                      +971 56 455 6555
                    </a>
                  </span>
                  <span className="d-block">
            ...
            <div className="col icon-with-text-style-03">
              <div className="feature-box p-8">
                ...
                <div className="feature-box-content last-paragraph-no-margin">
                  ...
                  <span className="d-block">
                    <span className="text-white fw-600">هـ:</span>{" "}
                    <a href="tel:600500387" className="urbanist" dir="ltr">
                      600 500 387
                    </a>
                  </span>
                  <span className="d-block">
            ...
            <div className="col icon-with-text-style-03">
              <div className="feature-box p-8">
                ...
                <div className="feature-box-content last-paragraph-no-margin">
                  ...
                  <span className="d-block">
                    <span className="text-white fw-600">هـ:</span>{" "}
                    <a href="tel:+971569863920" className="urbanist" dir="ltr">
                      +971 56 986 3920
                    </a>
                  </span>
                  <span className="d-block">
