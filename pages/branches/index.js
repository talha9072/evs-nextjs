...
<section className="position-relative">
  ...
  <div className="container position-relative">
    ...
    {/* ROW 1: All Dubai branches (3 on lg+) */}
    <div
            ...
            <div className="feature-box-content last-paragraph-no-margin">
              <div className="d-none d-lg-flex align-items-center justify-content-between gap-2">
                ...
                <div className="d-flex align-items-center">
                  <a href={`tel:${branch.phone}`} className="btn btn-small btn-round-edge btn-base-color me-10px">
                    <i className="feather icon-feather-phone-call"></i>
                  </a>
                  <a href="mailto:info@evsuae.com" className="btn btn-small btn-round-edge btn-base-color me-10px">
    ...
    {/* ROW 2: All Sharjah branches (2 on lg+, centered) */}
    <div
    ...
    {/* ROW 3: All Abu Dhabi branches (2 on lg+, centered) */}
    <div
      className="row row-cols-1 row-cols-md-2 justify-content-center mb-5 md-mb-7"
      data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'
    >
      {[
        ...
        {
          title: "EVS Abu Dhabi - Al Mushrif",
